...
DISPLAY_STAT_ALIASES = {
    ...
    "P-Adj_tackles_total": ["P-Adj_tackles_total"],
    "P-Adj_tackles_won": ["P-Adj_tackles_won"],
    "P-Adj_interceptions": ["P-Adj_interceptions"],
    "P-Adj_clearances": ["P-Adj_clearances"],
    "blocked_shots": ["blocked_shots"],
    "P-Adj_recoveries": ["P-Adj_recoveries"],
